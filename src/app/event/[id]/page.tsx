...
const getEventData = (id: string) => {
  const events = {
    '1': {
      ...
      description: 'Join us for an exciting evening of networking and tech discussions. We\'ll cover the latest trends in AI, blockchain, and web development. Perfect for developers, designers, and tech enthusiasts.',
      attendees: 156,
      maxAttendees: 200,
    ...
    '2': {
      ...
      description: 'A hands-on workshop covering modern design principles, user experience best practices, and creative problem-solving techniques. Bring your laptop and creativity!',
      attendees: 89,
      maxAttendees: 100,
    ...
    '3': {
      ...
      description: 'The premier blockchain and cryptocurrency conference featuring industry leaders, innovative projects, and networking opportunities. Don\'t miss this chance to connect with the crypto community.',
      attendees: 500,
      maxAttendees: 500,
      ...
      <Page.Header className="p-0">
        <div className="bg-white shadow-sm border-b">
          <div className="px-4 py-4 flex items-center gap-4">
            <Link href="/" className="p-2 rounded-md hover:bg-gray-100 transition-colors">
              ← Back
            </Link>
        ...
        <div className="px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-lg shadow-sm border p-4">
              ...
              <div className="space-y-3">
                {mockProfiles.map((profile) => (
                  <Link key={profile.id} href={`/profile/${profile.id}`} className="flex items-center gap-3 hover:bg-gray-50 p-2 rounded-md transition-colors">
                    <img
            ...
            <div className="bg-white rounded-lg shadow-sm border p-4">
              ...
              <div className="space-y-3">
                {mockProfiles.filter(profile => profile.isInMyCircle).map((profile) => (
                  <Link key={profile.id} href={`/profile/${profile.id}`} className="flex items-center gap-3 hover:bg-gray-50 p-2 rounded-md transition-colors">
                    <img
                      src={profile.profilePicture}
                      alt={profile.name}
                ...
                {mockProfiles.filter(profile => profile.isInMyCircle).length === 0 && (
